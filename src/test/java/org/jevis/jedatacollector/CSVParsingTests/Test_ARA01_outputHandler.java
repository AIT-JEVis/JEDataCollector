 ...
 * @author bf
 */
public class Test_ARA01_outputHandler {
    ...
    public void test_ARA01() throws Exception {
        ...
        Request request = RequestGenerator.createOnlyParsingRequestWithOutput(fileParser, inputHandler,"/home/bf/ara01output.csv");
